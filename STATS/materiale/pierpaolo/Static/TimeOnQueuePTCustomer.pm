# --
# Kernel/System/Stats/TimeOnQueuePTCustomer.pm - stats module
# Copyright (C) 2001-2009 OTRS AG, http://otrs.org/
# --
# $Id: TimeOnQueuePTCustomer.pm,v 1.1 2011/12/14 08:16:26 rk Exp $
# --
...
package Kernel::System::Stats::Static::TimeOnQueuePTCustomer;
...
sub Run {
    ...
    my @HeadData = ('Ticket ID','Data Creazione', 'Data Chiusura', 'Tipo', 
    				'Codice Cliente', 'Creato da', "Priorita'", 'Stato','Oggetto','Descrizione','Ticket collegati','Coda corrente','Tempo permanenza');
    ...
    push @Filter, "ticket.customer_id = '100060452100'"; #Solo i ticket di postino telematico!
	#push @Filter, "ticket.queue_id IN (53,54,55)";				
	push @Filter, "queue.name IN ('CC-PT','PostinoTelematico')";				
	...
	LEFT JOIN ticket_history th ON
		...
		AND th.id = (	
							...
							INNER JOIN queue queue_sub ON
								...
								AND queue_sub.name = 'PostinoTelematico'
							WHERE
