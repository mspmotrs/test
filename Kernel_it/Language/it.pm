...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Logout successful. Thank you for using OTRS!' => 'Disconnessione avvenuta con successo. Chiudere il browser per completare la lavorazione.  Grazie per aver usato OTRS!',
        ...
        'Created Priority' => 'Priorità di creazione',
        'Created State' => 'Stato di creazione',
        ...
        'Attributes to be printed' => 'Attributi da stampare',
...
#        'Ticket' => 'Richiesta',
        ...
        'closed successful' => 'Chiuso RIS',
        'closed unsuccessful' => 'Chiuso NdC',
        'closed unsuccessful inf' => 'Chiuso INF',
        'new' => 'nuovo',
        ...
        'Closed' => 'Chiuso',
        'removed' => 'rimosso',
        'pending reminder' => 'In Attesa Informazioni',
        'pending auto' => '',
        #'pending auto close+' => 'in attesa di chiusura automatica+',
        'pending auto close+' => 'Risolto',
        'pending auto close-' => 'Non di Competenza',
        'email-external' => 'Email esterna',
        'email-internal' => 'Email interna',
        'note-external' => 'Nota esterna per CC',
        'note-internal' => 'Nota interna',
        'note-report' => 'Nota rapporto',
        'note-external-pending' => 'Nota esterna di risoluzione/chiusura',
        'note-external-Siebel' => 'Nota esterna da Siebel',
        'note-external-ToPI' => 'Nota esterna per PI', 
        'note-external-FromPI' => 'Nota esterna da PI',
        'note-external-ToCorner' => 'Nota esterna per Corner',
        #MS_full (inizio)
        'note-external-ToWind' => 'Nota esterna per Wind',
        'note-external-FromWind' => 'Nota esterna da Wind',
        'ChiusoNRI' => 'Chiuso NRI',
        'ChiusoNoACT' => 'Chiuso NoACT',
        #MS_full (fine)
        'phone' => 'telefono',
        'sms' => '',
        ...
        #'unlock' => 'abbandona gestione',
        'lock' => 'in gestione',
        'unlock' => 'non in gestione',
        'very low' => 'molto basso',
        'low' => 'basso',
        'normal' => 'normale',
        'high' => 'alto',
        'very high' => 'molto alto',
        '0 very low' => '1 molto bassa',
        '1 low' => '1 bassa',
        '2 medium' => '2 normale',
        '3 high' => '3 alta',
        '4 very high' => '4 molto alta',
        ...
        #'Phone-Ticket' => 'Richiesta-Telefonica',
				'Phone-Ticket' => 'Nuova-Richiesta-GUI',
        ...
        'Set this ticket to pending!' => 'Imposta questa richiesta come Risolta/Non di Competenza/In Attesa Informazioni',
        ...
        'History::PriorityUpdate' => 'Priorità\' cambiata da "%s" (%s) a "%s" (%s).',
        ...
        'Add a new Priority.' => 'Aggiungi nuova Priorità\' ',
        ...
        'TicketFreeText' => 'Proprietà del ticket',
        ...
        '%s is not writable!' => '',
        'Cannot create %s!' => '',
        'Customer Infos' => 'Dettaglio Utente',
        'Articles' => 'Note Ticket',
        
        'CustomerName' => 'Cliente Proprietario',
        'TicketFreeTime4' => 'Data prevista risoluzione',
    };
    # $$STOP$$
    return;
}
