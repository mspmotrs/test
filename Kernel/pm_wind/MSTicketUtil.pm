...
sub MS_CreateAlarm
{
	...
	if(defined($alarmID) and $alarmID > 0)
	{
		...
		{
			#TODO: gestione errore creazione nota
		}
...
sub MS_AddArticleToTicket
{
	...
	my $ArticleID = $MS_ArticleInfo_ptr->{TicketObject}->ArticleCreate(
...
#
#output:
# il valore di ritorno della ArticleWriteAttachment
#
# interfaccia (infoHash_ptr)
sub MS_AddAttachmentToArticle
{
   ...
   return	$MS_Attachment_info_ptr->{TicketObject}->ArticleWriteAttachment(
